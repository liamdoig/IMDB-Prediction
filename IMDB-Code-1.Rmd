...
```{r}
predictors = c(2,5,7,8,9,14,18,29,31,57,59)
predictorSet = imdb[,predictors]

combinedReg = lm(imdb_score~duration_mins+country+content_rating+aspect_ratio+actor_1_facebook_likes+actor_2_facebook_likes+number_of_faces_in_movie_poster+movie_budget+distributor10+director_column10, data=imdb)
summary(combinedReg)

comboReg = lm(imdb_score~.,data=predictorSet)
summary(comboReg)
