...
cv.glm(imdb, comboReg, K=46)$delta[1] #MSE=0.99
summary(comboReg)
...
cv.glm(imdb, comboReg2, K=46)$delta[1] #MSE= 1.7
summary(comboReg2)
################ Now .827
...
cv.glm(imdb, comboReg3, K=46)$delta[1] #MSE= 0.98
summary(comboReg3)
...
cv.glm(imdb, comboReg4, K=46)$delta[1] #MSE= 0.96
summary(comboReg4)
##################### Now .87
...
cv.glm(imdb, comboReg5, K=46)$delta[1] #MSE= 0.96
summary(comboReg5)
...
cv.glm(imdb, comboReg6, K=46)$delta[1] #MSE= 0.77
summary(comboReg6)
...
cv.glm(imdb, comboReg7, K=46)$delta[1] #MSE= 0.77
summary(comboReg7)
...
cv.glm(imdb, comboReg8, K=52)$delta[1] #MSE= 0.947
summary(comboReg8)
...
cv.glm(imdb, comboReg9, K=52)$delta[1] #MSE= 0.951
summary(comboReg9)
...
cv.glm(imdb, comboReg10, K=52)$delta[1] #MSE= 0.9469
summary(comboReg8)

comboReg10.1 = lm(imdb_score~poly(duration_mins,2)+poly(director_facebook_likes,4)+director_column10+actor1_10+distributor10,data=predictorSet10)
...
cv.glm(imdb, comboReg11, K=52)$delta[1] #MSE= 0.9199
summary(comboReg11)
################# Now .835
...
cv.glm(imdb, comboReg12, K=52)$delta[1] #MSE= 0.9179
summary(comboReg12)
################# Now .8339
...
cv.glm(imdb, comboReg13, K=52)$delta[1] #MSE= 0.917
summary(comboReg13)
...
```{r}
comboReg2 = glm(imdb_score~poly(duration_mins,2)+director_column10+action+thriller+romance+horror+drama+animation,data=predictorSet2)
cv.glm(imdb, comboReg2, K=46)$delta[1] 
summary(comboReg2)
################ Now .827
```
...
Tests
```{r}
comboS = glm(imdb_score~poly(duration_mins,2)+director_column10+action+thriller+romance+horror+drama,data=predictorSet2)
cv.glm(imdb, comboReg2, K=46)$delta[1] 
summary(comboReg2)
################ Now .827
```
