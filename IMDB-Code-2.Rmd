...
library(car)
# lm model
newest.lm = lm(imdb_score~poly(duration_mins,2)+director_column10+action+thriller+romance+horror+drama+animation+distributor10+number_of_faces_in_movie_poster+poly(movie_facebook_likes,2)+color+musical+content10, data=imdb)
...
color="Color",musical=0,content10="PG-13")) # Prediction = 6.774597

#Predicting Ralph Breaks the Internet
predict(newest, data.frame(duration_mins=112, director_column10="Other", action = 0, thriller=0,romance=0,horror=0,drama = 0, animation=1, distributor10="Walt Disney Studios Motion Pictures",number_of_faces_in_movie_poster= 0, movie_facebook_likes=1200,
color="Color",musical=0,content10="PG")) #Rating = 6.93055
